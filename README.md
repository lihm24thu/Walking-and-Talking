...
| Figure | Analysis | Script / Notebook |
|---|---|---|
| Fig. 2 | A neckband wireless neural recording platform for multiple behavior contexts | `scripts/` |
| Fig. 3 | Substantial local neural variability across behavioral contexts for different brain regions and participants revealed by single-channel linear decoding | `scripts/` |
